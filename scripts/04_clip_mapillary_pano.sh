...
for neighborhood in $neighborhoods; do
    ...
    $mapimg clip_mapillary_pano \
        --input_file_points=s3://wastebin/v0.1/mapillary/points_sequences/${neighborhood}_simplify_validated.geojson \
        --image_clip_size=1024 \
        --output_file_points=s3://wastebin/v0.1/mapillary/points_sequences/${neighborhood}_point_images.geojson \
        --output_images_path=s3://wastebin/v0.1/mapillary/images/$neighborhood \
